...
df <- fingertips_data(IndicatorID = ,
                      AreaTypeID = )
...
## Assign the two indicators Life Expectancy at Birth (90366) and Healthy Life Expectancy at Birth (90362) to a vector called ind
ind <- 
